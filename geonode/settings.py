...
_KEYCLOAK_SOCIALACCOUNT_PROVIDER = {
    "NAME": "Keycloak",
    "SCOPE": [
        "openid",
        "profile",
    ...
    "UID_FIELD": "sub",
    "GROUP_ROLE_MAPPER_CLASS": SOCIALACCOUNT_GROUP_ROLE_MAPPER,
    "ACCESS_TOKEN_URL": os.getenv("OIDC_ACCESS_TOKEN_URL", "https://auth-tech4you.opsi.lecce.it/auth/realms/farmtech/protocol/openid-connect/token"),
    "AUTHORIZE_URL": os.getenv("OIDC_AUTHORIZE_URL", "https://auth-tech4you.opsi.lecce.it/auth/realms/farmtech/protocol/openid-connect/auth"),
    "ID_TOKEN_ISSUER": os.getenv("OIDC_ID_TOKEN_ISSUER", "https://auth-tech4you.opsi.lecce.it/auth/realms/farmtech"),
    "PROFILE_URL": os.getenv("OIDC_PROFILE_URL", "https://auth-tech4you.opsi.lecce.it/auth/realms/farmtech/protocol/openid-connect/userinfo"),
    "OAUTH_PKCE_ENABLED": False,
    "CLIENT_ID": os.getenv("KEYCLOAK_CLIENT_ID", "farmtech-backend"),
    "SECRET": os.getenv("KEYCLOAK_CLIENT_SECRET", ""),
    "AUDIENCE": os.getenv("KEYCLOAK_AUDIENCE", "account"),
    "VERIFY_SSL": ast.literal_eval(os.getenv("KEYCLOAK_VERIFY_SSL", "True")),
    # Non specificare ACCOUNT_CLASS per usare quella predefinita del provider
}

SOCIALACCOUNT_PROVIDERS_DEFS = {
    "azure": _AZURE_SOCIALACCOUNT_PROVIDER, 
    "google": _GOOGLE_SOCIALACCOUNT_PROVIDER,
    "keycloak": _KEYCLOAK_SOCIALACCOUNT_PROVIDER
}

_SOCIALACCOUNT_PROVIDER = os.environ.get("SOCIALACCOUNT_PROVIDER", "keycloak")
